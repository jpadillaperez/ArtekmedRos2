...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\string_node_manager\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/string_node_manager/local_setup.bat"
