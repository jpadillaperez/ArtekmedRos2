...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\string_msgs_multiple_functions_ddl\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/string_msgs_multiple_functions_ddl/local_setup.bat"
