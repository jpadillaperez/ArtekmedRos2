...
set "AMENT_ENVIRONMENT_HOOKS[string_msgs_multiple_functions_ddl]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[string_msgs_multiple_functions_ddl] "%AMENT_CURRENT_PREFIX%\share\string_msgs_multiple_functions_ddl\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[string_msgs_multiple_functions_ddl] "%AMENT_CURRENT_PREFIX%\share\string_msgs_multiple_functions_ddl\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[string_msgs_multiple_functions_ddl]:;=";"%") do (
    call:call_file %%f
  )
