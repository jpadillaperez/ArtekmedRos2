...
set "AMENT_ENVIRONMENT_HOOKS[string_msgs_hololens_dll]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[string_msgs_hololens_dll] "%AMENT_CURRENT_PREFIX%\share\string_msgs_hololens_dll\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[string_msgs_hololens_dll] "%AMENT_CURRENT_PREFIX%\share\string_msgs_hololens_dll\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[string_msgs_hololens_dll]:;=";"%") do (
    call:call_file %%f
  )
