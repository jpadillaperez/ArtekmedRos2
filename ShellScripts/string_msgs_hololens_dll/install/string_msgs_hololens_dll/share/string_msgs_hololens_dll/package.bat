...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\string_msgs_hololens_dll\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/string_msgs_hololens_dll/local_setup.bat"
